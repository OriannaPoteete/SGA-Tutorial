...
raw_data <- read_excel("C:/Users/kopot/Desktop/Work/SGA/SGA_2290_WT_-1del_-2del_PC04202022.xlsx", 
                       sheet = "Sheet1")
raw_data
```
...
options(dplyr.width = Inf)
kable(raw_data_clean_t, caption = "Serum Growth Assay for GN02290", "latex", 
      booktabs = T) %>%
